...
<head>
	...
	<link href="{{ asset('css/pages/login-soft.css') }}" rel="stylesheet" type="text/css"/>
...
<body class="login">
	...
	<![endif]-->   
	<script src="{{ asset('/plugins/jquery-1.10.1.min.js') }}assets/plugins/jquery-slimscroll/jquery.slimscroll.min.js" type="text/javascript"></script>
	<script src="{{ asset('/plugins/jquery-1.10.1.min.js') }}assets/plugins/jquery.blockui.min.js" type="text/javascript"></script>  
	<script src="{{ asset('/plugins/jquery-1.10.1.min.js') }}assets/plugins/jquery.cookie.min.js" type="text/javascript"></script>
	<script src="{{ asset('/plugins/jquery-1.10.1.min.js') }}assets/plugins/uniform/jquery.uniform.min.js" type="text/javascript" ></script>
	<!-- END CORE PLUGINS -->
	<!-- BEGIN PAGE LEVEL PLUGINS -->
	<script src="{{ asset('/plugins/jquery-1.10.1.min.js') }}assets/plugins/jquery-validation/dist/jquery.validate.min.js" type="text/javascript"></script>
	<script src="{{ asset('/plugins/jquery-1.10.1.min.js') }}assets/plugins/backstretch/jquery.backstretch.min.js" type="text/javascript"></script>
